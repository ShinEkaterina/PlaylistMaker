...
import com.example.playlistmaker.library.domain.impl.ImagesRepositoryInteractorImpl
...
val interactorModule = module {
    ...
    single<ImagesRepositoryInteractor> {
        ImagesRepositoryInteractorImpl(get())
    }
